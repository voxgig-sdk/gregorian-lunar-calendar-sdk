// Command GregorianLunarCalendar-cli is a CLI + REPL for the GregorianLunarCalendar SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      GREGORIAN_LUNAR_CALENDAR_APIKEY (api key), GREGORIAN_LUNAR_CALENDAR_BASE (base url override)")
