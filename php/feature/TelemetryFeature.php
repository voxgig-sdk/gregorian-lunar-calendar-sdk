...
// GregorianLunarCalendar SDK telemetry feature
...
class GregorianLunarCalendarTelemetryFeature extends GregorianLunarCalendarBaseFeature
{
    ...
    private function _close(GregorianLunarCalendarContext $ctx, bool $ok): void
    {
