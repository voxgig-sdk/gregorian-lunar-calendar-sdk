...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.GREGORIANLUNARCALENDAR_TEST_LIVE ||
    'TRUE' === process.env.GREGORIANLUNARCALENDAR_TEST_OVERRIDE
  ) {
  ...
  m.GREGORIANLUNARCALENDAR_TEST_EXPLAIN = process.env.GREGORIANLUNARCALENDAR_TEST_EXPLAIN || m.GREGORIANLUNARCALENDAR_TEST_EXPLAIN
