...
#      offline in seeded test mode (GregorianLunarCalendarSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "GregorianLunarCalendar_sdk.rb")
  SDK_CLASS = "GregorianLunarCalendarSDK"
  ...
  SDK_BASE = "GregorianLunarCalendar_sdk"
