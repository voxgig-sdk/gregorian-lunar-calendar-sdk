...
class LunardateEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set GREGORIANLUNARCALENDAR_TEST_LUNARDATE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def lunardate_basic_setup(extra)
  ...
  entid_env_raw = ENV["GREGORIANLUNARCALENDAR_TEST_LUNARDATE_ENTID"]
