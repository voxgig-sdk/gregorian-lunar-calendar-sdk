...
// GregorianLunarCalendar SDK netsim feature
...
class GregorianLunarCalendarNetsimFeature extends GregorianLunarCalendarBaseFeature
{
    ...
    private function _simulate(GregorianLunarCalendarContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GregorianLunarCalendarContext $ctx, array $applied): void
    {
        $client = $this->client;
