...
// GregorianLunarCalendar SDK streaming feature
...
class GregorianLunarCalendarStreamingFeature extends GregorianLunarCalendarBaseFeature
{
    ...
    private function _iterate(GregorianLunarCalendarResult $result): \Generator
    {
    ...
    private function _streamable(GregorianLunarCalendarContext $ctx): bool
    {
