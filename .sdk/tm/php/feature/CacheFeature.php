...
// GregorianLunarCalendar SDK cache feature
...
class GregorianLunarCalendarCacheFeature extends GregorianLunarCalendarBaseFeature
{
    ...
    private function _through(GregorianLunarCalendarContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
