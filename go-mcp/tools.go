...
func registerTools(server *mcp.Server, client *sdk.GregorianLunarCalendarSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "gregorian-lunar-calendar_list",
		Description: "List records from GregorianLunarCalendar. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "gregorian-lunar-calendar_load",
		Description: "Load a single record from GregorianLunarCalendar. " +
...
func runOp(client *sdk.GregorianLunarCalendarSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
