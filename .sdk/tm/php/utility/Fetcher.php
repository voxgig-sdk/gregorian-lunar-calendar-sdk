...
// GregorianLunarCalendar SDK utility: fetcher

class GregorianLunarCalendarFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GregorianLunarCalendarSDK/1.0)';
    ...
    public static function call(GregorianLunarCalendarContext $ctx, string $fullurl, array $fetchdef): array
    {
