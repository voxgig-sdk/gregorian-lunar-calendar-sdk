...
// GregorianLunarCalendar SDK rbac feature
...
class GregorianLunarCalendarRbacFeature extends GregorianLunarCalendarBaseFeature
{
    ...
    private function _required(GregorianLunarCalendarContext $ctx): ?string
    {
    ...
    private function _reject(GregorianLunarCalendarContext $ctx, string $required): void
    {
    ...
    private function _track(GregorianLunarCalendarContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
