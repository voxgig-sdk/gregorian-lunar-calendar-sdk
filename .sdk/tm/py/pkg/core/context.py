...
from projectname_sdk.core.control import GregorianLunarCalendarControl
...
class GregorianLunarCalendarContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = GregorianLunarCalendarControl()
        ...
        if isinstance(sp, GregorianLunarCalendarSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, GregorianLunarCalendarResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, GregorianLunarCalendarResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return GregorianLunarCalendarOperation({})
    ...
    def make_error(self, code, msg):
        return GregorianLunarCalendarError(code, msg, self)
