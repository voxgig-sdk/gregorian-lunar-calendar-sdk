...
// instead of `sdk.NewGregorianLunarCalendarSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *GregorianLunarCalendarSDK  { return NewGregorianLunarCalendarSDK(nil) }
func Test() *GregorianLunarCalendarSDK { return TestSDK(nil, nil) }
