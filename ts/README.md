# GregorianLunarCalendar TypeScript SDK

The TypeScript SDK for the GregorianLunarCalendar API. Provides a type-safe, entity-oriented interface with full async/await support.
...
| Method | Returns | Description |
| --- | --- | --- |
| `GregorianLunarCalendarSDK.test(testopts?, sdkopts?)` | `GregorianLunarCalendarSDK` | Create a test-mode client. |
...
| `client` | `client(): GregorianLunarCalendarSDK` | Return the parent SDK client. |
...
├── src/
│   ├── GregorianLunarCalendarSDK.ts        # Main SDK class
