...
// GregorianLunarCalendar SDK audit feature
...
class GregorianLunarCalendarAuditFeature extends GregorianLunarCalendarBaseFeature
{
    ...
    private function _emit(GregorianLunarCalendarContext $ctx, string $outcome): void
    {
