...
// GregorianLunarCalendar SDK utility type

class GregorianLunarCalendarUtility
{
    ...
    public static function copy(GregorianLunarCalendarUtility $src): GregorianLunarCalendarUtility
    {
        $u = new GregorianLunarCalendarUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
