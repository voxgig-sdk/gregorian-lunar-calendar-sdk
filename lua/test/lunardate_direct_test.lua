...
describe("LunardateDirect", function()
  it("should direct-load-lunardate", function()
    local setup = lunardate_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-lunardate", setup.live and "live" or "unit")
...
function lunardate_direct_setup(mockres)
