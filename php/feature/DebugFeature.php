...
// GregorianLunarCalendar SDK debug feature
...
class GregorianLunarCalendarDebugFeature extends GregorianLunarCalendarBaseFeature
{
    ...
    private function _finish(GregorianLunarCalendarContext $ctx, bool $ok): void
    {
