...
function envOverride(m) {
    if ('TRUE' === process.env.GREGORIAN_LUNAR_CALENDAR_TEST_LIVE ||
        'TRUE' === process.env.GREGORIAN_LUNAR_CALENDAR_TEST_OVERRIDE) {
    ...
    m.GREGORIAN_LUNAR_CALENDAR_TEST_EXPLAIN = process.env.GREGORIAN_LUNAR_CALENDAR_TEST_EXPLAIN || m.GREGORIAN_LUNAR_CALENDAR_TEST_EXPLAIN;
    return m;
}
