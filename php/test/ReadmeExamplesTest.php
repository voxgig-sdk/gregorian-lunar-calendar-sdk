...
// GregorianLunarCalendar SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GregorianLunarCalendarSDK::test)
...
{
    private const SDK_CLASS = 'GregorianLunarCalendarSDK';
    ...
    private const SDK_BASE = 'gregorianlunarcalendar_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../gregorianlunarcalendar_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
