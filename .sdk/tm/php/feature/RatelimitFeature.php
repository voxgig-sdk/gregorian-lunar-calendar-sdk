...
// GregorianLunarCalendar SDK ratelimit feature
...
class GregorianLunarCalendarRatelimitFeature extends GregorianLunarCalendarBaseFeature
{
    ...
    private function _acquire(GregorianLunarCalendarContext $ctx): void
    {
    ...
    private function _track(GregorianLunarCalendarContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
