...
|---|---|---|
| `ts/` | @voxgig-sdk/gregorian-lunar-calendar-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/gregorian-lunar-calendar-sdk \
      --repository voxgig-sdk/gregorian-lunar-calendar-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/gregorian-lunar-calendar-sdk` shows it, and
`npm trust revoke @voxgig-sdk/gregorian-lunar-calendar-sdk --id=<id>` removes it.
