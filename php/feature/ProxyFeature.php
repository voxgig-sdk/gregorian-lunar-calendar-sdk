...
// GregorianLunarCalendar SDK proxy feature
...
class GregorianLunarCalendarProxyFeature extends GregorianLunarCalendarBaseFeature
{
    ...
    public function init(GregorianLunarCalendarContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GregorianLunarCalendarContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
