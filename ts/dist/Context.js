...
const GregorianLunarCalendarError_1 = require("./GregorianLunarCalendarError");
...
class Context {
    ...
    error(code, msg) {
        return new GregorianLunarCalendarError_1.GregorianLunarCalendarError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
