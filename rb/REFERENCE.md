# GregorianLunarCalendar Ruby SDK Reference

Complete API reference for the GregorianLunarCalendar Ruby SDK.
...
#### `GregorianLunarCalendarSDK.test(testopts = nil, sdkopts = nil)`
