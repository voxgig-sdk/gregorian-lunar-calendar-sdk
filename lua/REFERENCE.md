# GregorianLunarCalendar Lua SDK Reference

Complete API reference for the GregorianLunarCalendar Lua SDK.
...
```lua
local result, err = client:Lunardate(nil):load({ id = "lunardate_id" }, nil)
```
