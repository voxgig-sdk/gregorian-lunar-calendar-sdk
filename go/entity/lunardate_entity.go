...
type LunardateEntity struct {
	name    string
	client  *core.GregorianLunarCalendarSDK
...
func NewLunardateEntity(client *core.GregorianLunarCalendarSDK, entopts map[string]any) *LunardateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LunardateEntity) GetName() string { return e.name }
...
func (e *LunardateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LunardateEntity) Deleted() bool {
	return e.deleted
}


func (e *LunardateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLunardateEntity(e.client, opts)
}

func (e *LunardateEntity) Data(args ...any) any {
...
func (e *LunardateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Lunardate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LunardateEntity) DataTyped(data ...Lunardate) Lunardate {
	if len(data) > 0 {
		return typedFrom[Lunardate](e.Data(asMap(data[0])))
	}
	return typedFrom[Lunardate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Lunardate (all fields
// optional at the wire level).
func (e *LunardateEntity) MatchTyped(match ...Lunardate) Lunardate {
	if len(match) > 0 {
		return typedFrom[Lunardate](e.Match(asMap(match[0])))
	}
	return typedFrom[Lunardate](e.Match())
}
...
func (e *LunardateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LunardateEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LunardateLoadMatch and returns an Lunardate. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LunardateEntity) LoadTyped(reqmatch LunardateLoadMatch, ctrl map[string]any) (Lunardate, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Lunardate{}, err
	}
	return typedFrom[Lunardate](res), nil
}



func (e *LunardateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *LunardateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LunardateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LunardateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LunardateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
