# GregorianLunarCalendar PHP SDK Reference

Complete API reference for the GregorianLunarCalendar PHP SDK.
...
#### `GregorianLunarCalendarSDK::test($testopts = null, $sdkopts = null)`
