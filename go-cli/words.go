...
func registerSDKWords(r *eng.Registry, client *sdk.GregorianLunarCalendarSDK) {
...
func runOp(client *sdk.GregorianLunarCalendarSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
