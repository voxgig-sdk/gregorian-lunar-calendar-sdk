...
AQL-driven CLI and REPL for the GregorianLunarCalendar SDK. Positional arguments are
...
```sh
go build -o gregorian-lunar-calendar-cli ./...
```
...
./gregorian-lunar-calendar-cli list lunardate
./gregorian-lunar-calendar-cli load 1 lunardate
./gregorian-lunar-calendar-cli load '{id:1}' lunardate
