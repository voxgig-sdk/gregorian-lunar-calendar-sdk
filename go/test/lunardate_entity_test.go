...
func TestLunardateEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		lunardateRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.lunardate")))
...
func lunardateBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("GREGORIAN_LUNAR_CALENDAR_TEST_LUNARDATE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["GREGORIAN_LUNAR_CALENDAR_TEST_LUNARDATE_ENTID"])
