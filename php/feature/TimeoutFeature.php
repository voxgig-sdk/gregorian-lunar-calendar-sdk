...
// GregorianLunarCalendar SDK timeout feature
...
class GregorianLunarCalendarTimeoutFeature extends GregorianLunarCalendarBaseFeature
{
    ...
    private function _with_timeout(GregorianLunarCalendarContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GregorianLunarCalendarContext $_ctx, float $ms): void
    {
        $client = $this->client;
