# GregorianLunarCalendar SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GregorianLunarCalendarSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GregorianLunarCalendarSDK(...) and GregorianLunarCalendarSDK.test(...) become
#      GregorianLunarCalendarSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "gregorianlunarcalendar_sdk"
_SDK_CLASS = "GregorianLunarCalendarSDK"
