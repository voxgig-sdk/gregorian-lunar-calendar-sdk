...
// GregorianLunarCalendar SDK utility: graphql
//
...
class GregorianLunarCalendarGraphql
{
    ...
    // equivalent.
    public static function body(GregorianLunarCalendarContext $ctx): mixed
    {
    ...
    public static function errors(GregorianLunarCalendarContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
