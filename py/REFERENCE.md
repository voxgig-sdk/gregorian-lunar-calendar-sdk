# GregorianLunarCalendar Python SDK Reference

Complete API reference for the GregorianLunarCalendar Python SDK.
...
#### `GregorianLunarCalendarSDK.test(testopts=None, sdkopts=None)`
...
```python
result, err = client.Lunardate().load({"id": "lunardate_id"})
```
