...
from gregorianlunarcalendar_sdk.utility import register

# Load features
from gregorianlunarcalendar_sdk.feature.base_feature import GregorianLunarCalendarBaseFeature
from gregorianlunarcalendar_sdk.features import _has_feature, _make_feature
...
class GregorianLunarCalendarSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = GregorianLunarCalendarUtility()
        self._utility = utility

        from gregorianlunarcalendar_sdk.config import shared_config
    ...
    def get_utility(self):
        return GregorianLunarCalendarUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("GregorianLunarCalendarSDK: graphql: " + str(msg))
            res["graphql"] = errors
