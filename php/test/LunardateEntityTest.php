...
class LunardateEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set GREGORIANLUNARCALENDAR_TEST_LUNARDATE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function lunardate_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("GREGORIANLUNARCALENDAR_TEST_LUNARDATE_ENTID");
