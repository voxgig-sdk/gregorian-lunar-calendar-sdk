...
(0, node_test_1.describe)('LunardateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.GregorianLunarCalendarSDK({
    ...
    (0, node_test_1.test)('direct-load-lunardate', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-lunardate', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.GregorianLunarCalendarSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['GREGORIAN_LUNAR_CALENDAR_TEST_LUNARDATE_ENTID'];
    ...
    const client = new __1.GregorianLunarCalendarSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=LunardateDirect.test.js.map