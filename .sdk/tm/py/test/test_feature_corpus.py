# GregorianLunarCalendar SDK feature corpus test
#
...
def _client(kase):
    ...
    GregorianLunarCalendarSDK(...), not GregorianLunarCalendarSDK.test(...): the `test` feature is
    ...
    return GregorianLunarCalendarSDK(opts)
