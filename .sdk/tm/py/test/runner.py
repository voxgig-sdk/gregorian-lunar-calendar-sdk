...
class GregorianLunarCalendarTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GregorianLunarCalendarTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = GregorianLunarCalendarTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = GregorianLunarCalendarTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
