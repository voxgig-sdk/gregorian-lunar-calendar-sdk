...
// GregorianLunarCalendar SDK clienttrack feature
...
class GregorianLunarCalendarClienttrackFeature extends GregorianLunarCalendarBaseFeature
{
    ...
    public function PostConstruct(GregorianLunarCalendarContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'GregorianLunarCalendar-SDK';
