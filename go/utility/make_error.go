...
import "github.com/voxgig-sdk/gregorian-lunar-calendar-sdk/go/core"
...
func makeErrorUtil(ctx *core.Context, err error) (any, error) {
	...
	sdkErr := &core.GregorianLunarCalendarError{
	...
	if se, ok := err.(*core.GregorianLunarCalendarError); ok {
		sdkErr.Code = se.Code
	}
