...
// GregorianLunarCalendar SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class GregorianLunarCalendarMakeSpec
{
    public static function call(GregorianLunarCalendarContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = GregorianLunarCalendarGraphql::CONTENT_TYPE;
        } else {
